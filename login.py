...
def edit():
    ...
    if request.method=='POST':
        ...
        for row in range(3,sheet.max_row + 1):
               ...
               # else:
                #    print(sheet['%s%s' % (get_column_letter(col+int(period)-1),str(row))].value)
        if len(class_id1)>7:
...
Date :'''+currentDate+'''<br> Roll num:<input type="text" name="roll"><br>   Period Num :<input type="text" name="period" ><br>Attendance : On Duty <br><br> <input type="submit" value="submit" name="submit">
</form><br>
<body>
<button onclick="myFunction()">Print this page</button>
